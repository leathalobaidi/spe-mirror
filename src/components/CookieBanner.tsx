  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 cookie-banner" role="alertdialog" aria-label="Cookie consent" aria-describedby="cookie-desc">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-4">
        <div className="bg-white rounded-2xl shadow-2xl border border-spe-border/20 p-4 sm:p-5 flex flex-col sm:flex-row items-start sm:items-center gap-4">
          <div className="flex-1 min-w-0">
            <p className="text-sm text-spe-dark font-medium">We value your privacy</p>
