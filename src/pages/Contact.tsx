    ...
    <div>
      ...
      <div className="bg-gradient-to-br from-spe-deep2 via-spe-deep to-spe-blue text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20">
          <p className="editorial-subheading text-spe-light mb-3">Get in Touch</p>
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-12">
          ...
          <div className="lg:col-span-3">
            <div className="rounded-2xl border border-spe-border/30 bg-white p-8 sm:p-10">
              ...
              >
                <div>
                  <label htmlFor="name" className="block text-sm font-medium text-spe-dark mb-1.5">
                ...
                <div>
                  <label htmlFor="company" className="block text-sm font-medium text-spe-dark mb-1.5">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                  <div>
                    <label htmlFor="email" className="block text-sm font-medium text-spe-dark mb-1.5">
                  ...
                  <div>
                    <label htmlFor="telephone" className="block text-sm font-medium text-spe-dark mb-1.5">
                ...
                <div>
                  <label htmlFor="message" className="block text-sm font-medium text-spe-dark mb-1.5">
          ...
          <div className="lg:col-span-2 space-y-6">
            {/* General enquiries */}
            <div className="rounded-2xl border border-spe-border/30 bg-white p-7">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="font-serif font-bold text-spe-dark">General Enquiries</h3>
              </div>
            ...
            <div className="rounded-2xl border border-spe-border/30 bg-white p-7">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="font-serif font-bold text-spe-dark">Membership</h3>
              </div>
              <p className="text-sm text-spe-muted leading-relaxed mb-3">
            ...
            <div className="rounded-2xl border border-spe-border/30 bg-white p-7">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="font-serif font-bold text-spe-dark">Advertising</h3>
              </div>
              <p className="text-sm text-spe-muted leading-relaxed mb-3">
            ...
            {/* Social media */}
            <div className="rounded-2xl bg-gradient-to-br from-slate-50 to-slate-100/50 border border-spe-border/20 p-7">
              <h3 className="font-serif font-bold text-spe-dark mb-3">Follow Us</h3>
              <div className="flex items-center gap-4">
                <a
                  href="https://twitter.com/econ_SPE"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-10 h-10 rounded-lg bg-white border border-spe-border/20 flex items-center justify-center hover:border-spe-blue/30 transition-colors"
                  aria-label="Follow SPE on X (Twitter)"
                >
                  <svg className="w-4 h-4 text-spe-dark" viewBox="0 0 24 24" fill="currentColor">
