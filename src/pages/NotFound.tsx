...
const quickLinks = [
  ...
  { to: '/podcasts', label: 'Podcasts', icon: 'M19 11a7 7 0 01-7 7m0 0a7 7 0 01-7-7m7 7v4m0 0H8m4 0h4m-4-8a3 3 0 01-3-3V5a3 3 0 116 0v6a3 3 0 01-3 3z' },
  { to: '/reading-room', label: 'Reading Room', icon: 'M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253' },
  { to: '/speakers/evening-talks', label: 'Evening Talks', icon: 'M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z' },
  ...
  { to: '/about', label: 'About SPE', icon: 'M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z' },
]

export default function NotFound() {
  useSEO({
    title: 'Page Not Found',
    description: 'Page not found. Return to the SPE homepage to find what you are looking for.',
    type: 'website',
    noindex: true,
  })
    ...
    <div className="min-h-[70vh] flex flex-col">
      ...
      <div className="bg-gradient-to-br from-spe-deep2 via-spe-deep to-spe-blue text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20 text-center">
          ...
          <p className="text-white/60 max-w-lg mx-auto font-light leading-relaxed">
            ...
            Try searching for what you need or explore our most popular sections below.
          </p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 flex-1">
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center mb-14">
          <Link
            to="/"
            className="inline-flex items-center justify-center gap-2 bg-spe-blue text-white font-semibold px-7 py-3 rounded-xl hover:bg-spe-deep transition-colors shadow-md shadow-spe-blue/20"
          >
